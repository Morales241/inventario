...
public class FachadaPersonas implements IFachadaPersonas {
    ...
    public CuentaSistemaDTO login(String u, String p) {
        return servicioPersonas.login(u, p);
    }

    @Override
    public CuentaSistemaDTO buscarPorUsername(String u) {
        return servicioPersonas.buscarPorUsername(u);
    }

    @Override
    public CuentaSistemaDTO guardarCuentaSistema(CuentaSistemaDTO d) {
        return servicioPersonas.guardarCuentaSistema(d);
    }
    ...
    public List<CuentaSistemaDTO> buscarCuentasSistema(String f) {
        return servicioPersonas.buscarCuentasSistema(f);
    }

    // ── Usuarios ──────────────────────────────────────────────────────────────
    @Override
    public List<UsuarioDTO> buscarUsuarios(String b) {
        return servicioPersonas.buscarUsuarios(b);
    }
    ...
    @Override
    public void cambiarEstadoUsuario(Long id, boolean a) {
        servicioPersonas.cambiarEstadoUsuario(id, a);
    }
    ...
    @Override
    public List<UsuarioDTO> buscarUsuariosPorDepartamento(Long id) {
        return servicioPersonas.buscarUsuariosPorDepartamento(id);
    }

    @Override
    public List<UsuarioDTO> buscarUsuariosPorPuesto(Long id) {
        return servicioPersonas.buscarUsuariosPorPuesto(id);
    }

    @Override
    public boolean usuarioTieneEquiposAsignados(Long id) {
        return servicioPersonas.usuarioTieneEquiposAsignados(id);
    }
