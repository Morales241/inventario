...
/**
 * Interfaz para el servicio de gestión integral de equipos de cómputo. Define
 * operaciones para diferentes tipos de equipos y sus modelos asociados.
 */
public interface IServicioEquipos {
    ...
    /**
     * COUNT en BD para calcular el total de páginas.
     */
    long contarConFiltros(String texto, TipoEquipo tipo,
            CondicionFisica condicion, EstadoEquipo estado);
